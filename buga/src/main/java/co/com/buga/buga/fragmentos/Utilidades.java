 ...
 */
public class Utilidades extends Fragment {
    /**
     ...
     * number.
     */
    public static Utilidades newInstance(int seleccion) {
        Utilidades fragment= new Utilidades();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        View v;
        int layout=R.layout.fragment_utilidades;
