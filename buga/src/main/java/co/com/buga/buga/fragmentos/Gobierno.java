 ...
 */
public class Gobierno extends Fragment {
    /**
     ...
     * number.
     */
    public static Gobierno newInstance(int seleccion) {
        Gobierno fragment= new Gobierno();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        View v;
        int layout=R.layout.fragment_gobierno;
